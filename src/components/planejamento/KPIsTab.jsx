      ...
      <div className="flex flex-wrap gap-3 items-center justify-between bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
        <div className="flex flex-wrap gap-2 flex-1 min-w-0">
          <div className="relative">
            ...
            <Input className="pl-9 w-48" placeholder="Buscar KPI..." value={search} onChange={e => setSearch(e.target.value)} />
          </div>
          ...
          <Select value={filterPeriodicidade} onValueChange={setFilterPeriodicidade}>
            <SelectTrigger className="w-40"><SelectValue placeholder="Periodicidade" /></SelectTrigger>
            <SelectContent>
